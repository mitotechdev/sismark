    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <!-- Modal -->
                <form action="{{ route('product.store') }}" method="POST" class="form-create" id="form_add_item">
                    @csrf
                    @method('POST')
                                ...
                                <div class="modal-body">
                                    <div class="row mb-3 g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="product_code" name="code" placeholder="Ex: MEICHEM SC 01" title="Kode Produk" required>
                                        </div>
                                        <div class="col-md-8">
                                            <label class="form-label" for="product">Name Product</label>
                                            <input type="text" class="form-control" id="product" name="name_product" placeholder="Ex: Alkalinity Booster" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label" for="packaging">Packaging</label>
                                            <input type="text" class="form-control" id="packaging" name="packaging" placeholder="Ex: 25 kg/zak" title="Kemasan Produk" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label" for="unit">Unit</label>
                                            <input type="text" class="form-control" id="unit" name="unit" placeholder="Ex: Pill" title="Satuan Produk" required>
                                        </div>
                                        <div class="col-md-12">
