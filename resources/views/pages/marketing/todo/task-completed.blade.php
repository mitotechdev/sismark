    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="nav-align-top my-4">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a type="button" class="nav-link" role="tab"
                        href="{{ route('task.project', $project->id) }}"
                    >
                        Home
                    </a>
                </li>
                <li class="nav-item">
                    <a type="button" class="nav-link active" role="tab" href="javascript:void(0)">
                        Completed
                        <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-success">{{ $tasksCompleted->count() }}</span>
                    </a>
                </li>
            </ul>
